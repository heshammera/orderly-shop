            ...
            {offers.length === 0 ? (
                <Card className="p-6 text-center border-dashed border-2 bg-transparent">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                        {language === 'ar'
                            ? 'مثال: اشترِ قطعتين واحصل على خصم 15%'
                            : 'Example: Buy 2 and save 15%'}
                    </p>
                </Card>
            ) : (
                <div className="space-y-4">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder={language === 'ar' ? 'مثال: اشترِ قطعتين واحصل على خصم 15%' : 'e.g., Buy 2 save 15%'}
                                            dir="rtl"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder={language === 'ar' ? 'Buy 2 save 15%' : 'e.g., Buy 2 save 15%'}
                                            dir="ltr"
                                        />
                                    </div>
                                </div>
                                    ...
                                    <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg p-3 border border-primary/20">
                                        ...
                                        <div className="flex items-center justify-center gap-2">
                                            ...
                                            {(offer.badgeAr || offer.badgeEn) && (
                                                <span className="bg-primary text-primary-foreground text-[10px] uppercase font-bold px-2 py-0.5 rounded-full">
