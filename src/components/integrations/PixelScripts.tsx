...
export function PixelScripts({ integrations }: PixelScriptsProps) {
    const pathname = usePathname();
    const searchParams = useSearchParams();

    // Fire pageview on route change for SPAs
    useEffect(() => {
        ...
        <>
            {integrations.flatMap((integration, integrationIndex) => {
                ...
                return pixelIds.map((pixelId, index) => {
                    ...
                    const key = `${integration.provider}-${integrationIndex}-${index}`;
