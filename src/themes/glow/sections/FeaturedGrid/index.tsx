...
export default function FeaturedGrid({ settings, blocks, storeContext, sectionId = 'featured_grid_1' }: FeaturedGridProps) {
    const mockProducts: ProductSnippet[] = [
        { id: 'prod_1', handle: 'product-1', title: 'سيروم النضارة الفائق', price: '180 SAR', image: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=800&q=80' },
        { id: 'prod_2', handle: 'product-2', title: 'مرطب الشفاه الوردي', price: '45 SAR', image: 'https://images.unsplash.com/photo-1599733594230-6b823276abcc?w=600&q=80' },
        { id: 'prod_3', handle: 'product-3', title: 'قناع الطين الطبيعي', price: '120 SAR', image: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=600&q=80' },
        { id: 'prod_4', handle: 'product-4', title: 'عطر الزهور البرية', price: '299 SAR', image: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=600&q=80' },
    ];
