...
export default function FeaturedGrid({ settings, blocks, storeContext, sectionId = 'featured_grid_1' }: FeaturedGridProps) {
    const mockProducts: ProductSnippet[] = [
        { id: 'prod_1', handle: 'product-1', title: 'عقد الألماس النادر', price: '12,500 SAR', image: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=800&q=80' },
        { id: 'prod_2', handle: 'product-2', title: 'خاتم ذهب عيار 21', price: '3,450 SAR', image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600&q=80' },
        { id: 'prod_3', handle: 'product-3', title: 'أقراط اللؤلؤ الفاخرة', price: '1,200 SAR', image: 'https://images.unsplash.com/photo-1535633302704-b02a41af7435?w=600&q=80' },
        { id: 'prod_4', handle: 'product-4', title: 'سوار ألماس كلاسيك', price: '8,900 SAR', image: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600&q=80' },
    ];
