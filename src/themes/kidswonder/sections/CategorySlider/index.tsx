            ...
            <div className="container px-4 mx-auto">
                    ...
                    <div className="space-y-2 text-center md:text-left">
                        {settings.heading && (
                            <InlineEditableText
                                ...
                                className="text-4xl md:text-5xl font-black text-[#ff6b6b] tracking-tight"
                            />
                        )}
                        {settings.subheading && (
                            <InlineEditableText
                                ...
                                className="text-[#ffbe0b] font-black uppercase tracking-widest text-[10px]"
                            />
                        )}
                    </div>
                    <div className="flex gap-4">
                        <button onClick={scrollRight} className="w-14 h-14 rounded-2xl bg-[#a2d2ff] text-white flex items-center justify-center hover:bg-[#7bc0ff] transition-all shadow-lg hover:-rotate-6">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6" /></svg>
                        </button>
                        <button onClick={scrollLeft} className="w-14 h-14 rounded-2xl bg-[#ffafcc] text-white flex items-center justify-center hover:bg-[#ff8fab] transition-all shadow-lg hover:rotate-6">
                ...
                <div className="relative group">
                    ...
                    <div
                        ...
                        className="flex overflow-x-auto gap-12 pb-10 snap-x snap-mandatory hide-scrollbar relative"
                    ...
                    >
                        {displayBlocks.map((block, index) => {
                            ...
                            return (
                                <Link key={block.id || index} href={block.settings.link || '#'} className="snap-start shrink-0 flex flex-col items-center group/item w-[150px] md:w-[200px]">
                                    <div className={`relative w-full aspect-square rounded-full overflow-hidden mb-6 border-8 ${borderColor} shadow-xl group-hover/item:scale-110 group-hover/item:-rotate-3 transition-all duration-500 bg-white p-2`}>
                                    ...
                                    <h3 className="font-black text-sm md:text-xl text-center text-[#2d2d2d] group-hover/item:text-[#ff6b6b] transition-colors line-clamp-2">
