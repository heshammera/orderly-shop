...
function GridItem({ item, size, onQuickView }: { item: ProductSnippet, size: 'full' | 'half', onQuickView: () => void }) {
    ...
    return (
        ...
        >
            <div
                className="relative block aspect-[4/5] md:aspect-auto h-full w-full cursor-pointer"
...
export default function FeaturedGrid({ settings, blocks, storeContext, sectionId = 'featured_grid_1' }: FeaturedGridProps) {
    ...
    const mockProducts: ProductSnippet[] = [
        { id: 'prod_1', handle: 'product-1', title: 'كنبة مخملية خضراء', price: `3,200 ${currency}`, image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&q=80' },
        { id: 'prod_2', handle: 'product-2', title: 'طاولة خشبية بسيطة', price: `850 ${currency}`, image: 'https://images.unsplash.com/photo-1581641033102-4f361ea335f6?w=600&q=80' },
        { id: 'prod_3', handle: 'product-3', title: 'كرسي القراءة المريح', price: `540 ${currency}`, image: 'https://images.unsplash.com/photo-1592078615290-033ee584e267?w=600&q=80' },
        { id: 'prod_4', handle: 'product-4', title: 'مصباح أرضي مودرن', price: `290 ${currency}`, image: 'https://images.unsplash.com/photo-1507473885765-e6ed03a2748e?w=600&q=80' },
    ];
