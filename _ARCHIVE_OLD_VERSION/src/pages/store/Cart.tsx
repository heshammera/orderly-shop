...
interface CartItem {
  ...
  variants: {
    ...
    optionId: string;
    optionLabel: { ar: string; en: string };
              ...
              <CardContent className="p-4">
                <div className="flex gap-4">
                  ...
                  <div className="w-24 h-24 rounded-lg bg-muted overflow-hidden flex-shrink-0">
                    {item.productImage ? (
                      <img
                        ...
                        alt={item.productName[language] || item.productName.ar}
                        className="w-full h-full object-cover"
                      />
                    ) : (
                      <div className="w-full h-full flex items-center justify-center">
                        <span className="text-2xl font-bold text-primary/20">
                          {(item.productName[language] || item.productName.ar).charAt(0)}
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <Link to={`/s/${storeSlug}/product/${item.productId}`}>
                      <h3 className="font-medium hover:text-primary transition-colors">
                        {item.productName[language] || item.productName.ar}
                      </h3>
                    </Link>
